inoremap <c-d> <esc>0v$di
inoremap <delete> <esc>xi
inoremap <C-d> <esc>ddi
inoremap <up> <esc>gka
nnoremap <f4> :!open -a safari %<cr><cr>
inoremap ;h1 <h1></h1>  <esc>hhhhho<enter><!--<++>--><esc>kkhhhhhhi
inoremap ;h2 <h2></h2>  <esc>hhhhho<enter><!--<++>--><esc>kkhhhhhhi
...
inoremap <tab><tab> <esc>/<!--<++>--><enter>"_c12l
